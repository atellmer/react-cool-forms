...
/* harmony import */ var react_cool_forms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react-cool-forms */ "./node_modules/react-cool-forms/index.js");
/* harmony import */ var react_cool_forms__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_cool_forms__WEBPACK_IMPORTED_MODULE_1__);


var App = function (props) {
    var repeaterRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null);
    var initialFormValue = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(function () { return ({
        rows: Array(1000)
            .fill(null)
            .map(function (_, idx) { return createRow("Row #".concat(idx)); }),
    }); }, []);
    var handleAppendRow = function () {
        repeaterRef.current.prepend(createRow(), true);
    };
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_cool_forms__WEBPACK_IMPORTED_MODULE_1__["Form"], { initialFormValue: initialFormValue, onSubmit: function (x) { return console.log('submit', x); } }, function (_a) {
        var submit = _a.submit, inProcess = _a.inProcess, reset = _a.reset;
        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null,
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { onClick: submit }, "Submit"),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { onClick: reset }, "Reset"),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { onClick: handleAppendRow }, "Add row"),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("table", { style: { width: '100%' } },
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("thead", null,
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null,
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Name"),
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Age"),
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Place"))),
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null,
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_cool_forms__WEBPACK_IMPORTED_MODULE_1__["Repeater"], { name: 'rows', connectedRef: repeaterRef, getValue: function (form) { return form.rows; }, setValue: function (form, value) { return (form.rows = value); }, getKey: function (x) { return x.ID; } }, function (_a) {
                        var idx = _a.idx, key = _a.key, shouldFocus = _a.shouldFocus, remove = _a.remove;
                        return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null,
                            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null,
                                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_cool_forms__WEBPACK_IMPORTED_MODULE_1__["Field"], { name: "rows(".concat(key, ").name"), getValue: function (row) { return row.name; }, setValue: function (row, value) { return (row.name = value); }, updatingKey: idx, validators: [required] }, function (_a) {
                                    var value = _a.value, error = _a.error, onChange = _a.onChange;
                                    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", { value: value, autoFocus: shouldFocus, style: createInputStyle(error), onChange: function (e) { return onChange(e.target.value); } }));
                                })),
                            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null,
                                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_cool_forms__WEBPACK_IMPORTED_MODULE_1__["Field"], { name: "rows(".concat(key, ").age"), getValue: function (row) { return row.age; }, setValue: function (row, value) { return (row.age = value); }, updatingKey: idx, validators: [required] }, function (_a) {
                                    var value = _a.value, error = _a.error, onChange = _a.onChange;
                                    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", { type: 'number', value: value, style: createInputStyle(error), onChange: function (e) { return onChange(Number(e.target.value)); } }));
                                })),
                            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null,
                                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_cool_forms__WEBPACK_IMPORTED_MODULE_1__["Field"], { name: "rows(".concat(key, ").place"), getValue: function (row) { return row.place; }, setValue: function (row, value) { return (row.place = value); }, updatingKey: idx, validators: [required] }, function (_a) {
                                    var value = _a.value, error = _a.error, onChange = _a.onChange;
                                    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", { value: value, style: createInputStyle(error), onChange: function (e) { return onChange(e.target.value); } }));
                                })),
                            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null,
                                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { style: { width: '100%' }, disabled: inProcess, onClick: function () { return remove(idx); } }, "Remove"))));
                    })))));
    }));
};
var required = {
...
var nextRowID = 0;
var getNextRowID = function () { return ++nextRowID; };
function createRow(name) {
    if (name === void 0) { name = ''; }
    return { ID: getNextRowID(), name: name, age: 22, place: '' };
}
function createInputStyle(error) {
    return {
        width: '100%',
...
root.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_app__WEBPACK_IMPORTED_MODULE_2__["App"], null));
...
/***/ "./node_modules/react-cool-forms/index.js":
/*!************************************************!*\
  !*** ./node_modules/react-cool-forms/index.js ***!
  \************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__(/*! ./umd/react-cool-forms.production.min */ "./node_modules/react-cool-forms/umd/react-cool-forms.production.min.js");


/***/ }),

/***/ "./node_modules/react-cool-forms/umd/react-cool-forms.production.min.js":
/*!******************************************************************************!*\
  !*** ./node_modules/react-cool-forms/umd/react-cool-forms.production.min.js ***!
  \******************************************************************************/
/*! no static exports found */
